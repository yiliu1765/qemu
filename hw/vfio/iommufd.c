...
static int vfio_iommufd_device_pasid_attach_hwpt(IOMMUFDDevice *idev,
                                                 uint32_t pasid,
                                                 uint32_t hwpt_id)
{
    VFIODevice *vbasedev = container_of(idev, VFIODevice, idev);
...
static int vfio_iommufd_device_pasid_detach_hwpt(IOMMUFDDevice *idev,
                                                 uint32_t pasid)
{
    VFIODevice *vbasedev = container_of(idev, VFIODevice, idev);
...
static IOMMUFDDeviceOps vfio_iommufd_device_ops = {
    ...
    .pasid_attach_hwpt = vfio_iommufd_device_pasid_attach_hwpt,
    .pasid_detach_hwpt = vfio_iommufd_device_pasid_detach_hwpt,
};
