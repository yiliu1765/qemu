                                            ...
                                            MemoryRegionSection *section)
{
    VFIORamDiscardListener *vrdl = container_of(rdl, VFIORamDiscardListener,
                                                listener);
    VFIOContainer *bcontainer = vrdl->container;
...
static void vfio_listener_log_global_start(MemoryListener *listener)
{
    ...
    vfio_container_set_dirty_page_tracking(bcontainer, true);
}
...
static void vfio_listener_log_global_stop(MemoryListener *listener)
{
    ...
    vfio_container_set_dirty_page_tracking(bcontainer, false);
}
...
static void vfio_iommu_map_dirty_notify(IOMMUNotifier *n, IOMMUTLBEntry *iotlb)
{
    ...
    if (vfio_get_xlat_addr(iotlb, NULL, &translated_addr, NULL)) {
        ...
        ret = vfio_container_get_dirty_bitmap(bcontainer, iova,
                                              iotlb->addr_mask + 1,
                                              translated_addr);
        if (ret) {
                                  ...
                                  MemoryRegionSection *section)
{
    ...
    return vfio_container_get_dirty_bitmap(bcontainer,
        ...
        MemoryRegionSection *section)
{
    ...
    if (vfio_container_devices_all_dirty_tracking(bcontainer)) {
        vfio_sync_dirty_bitmap(bcontainer, section);
    }
}
